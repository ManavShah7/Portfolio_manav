...
// The home page's About block. Its gutter is 17, not 24: the frame draws three
// 274-wide cards on an 856 measure and that only works at 17.
export const HOME = page(390, 856, 17)
// Peak's new frame: a 1162 measure centred on the 1900 axis, 32 gutter -
// which is the only gutter that gives the 565-wide two-up it draws.
export const PEAK = page(369, 1162, 32)
