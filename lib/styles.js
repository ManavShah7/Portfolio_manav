...
const S = {
  ...
  pkHead:       { size: 50,  weight: 700, lh: 66,   color: '#1C1C1E' },
  pkHeadW:      { size: 50,  weight: 700, lh: 66,   color: '#FFFFFF' },
  pkBig:        { size: 60,  weight: 700, lh: 78,   color: '#1C1C1E' },
  // --- Times Media's new frame ----------------------------------------------
  tmIntro:      { size: 40,  weight: 600, lh: 57,   color: '#FFFFFF' },
  tmHead:       { size: 50,  weight: 700, lh: 66,   color: '#1C1C1E' },
  tmHeadW:      { size: 50,  weight: 700, lh: 73,   color: '#FFFFFF' },
  tmBody:       { size: 26,  weight: 500, lh: 45,   color: '#8A8A8E' },
  tmBodyW:      { size: 26,  weight: 500, lh: 46,   color: '#86868B' },
  tmQuote:      { size: 24,  weight: 500, lh: 34,   color: '#1C1C1E' },
  tmImpact:     { size: 60,  weight: 700, lh: 78,   color: '#F14351' },
