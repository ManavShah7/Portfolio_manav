...
const S = {
  ...
  coSmall:      { size: 26,  weight: 600, lh: 31,  color: '#1C1C1E' },
  coRole:       { size: 26,  weight: 500, lh: 31,  color: '#1C1C1E' },
  coRoleSm:     { size: 18,  weight: 500, lh: 23,  color: '#1C1C1E' },
  coMeta:       { size: 22,  weight: 500, lh: 26,  color: '#6E6E73' },
  coMetaSm:     { size: 16,  weight: 500, lh: 21,  color: '#8A8A8E' },
  coBody:       { size: 22,  weight: 500, lh: 30,  color: '#000C32' },
  coNote:       { size: 17,  weight: 500, lh: 23,  color: '#3A3A3A' },
