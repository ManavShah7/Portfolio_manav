...
const css = `
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  :root{--blue:#60A5FA;--blue-light:#EFF6FF;--black:#0a0a0a;--gray:#f5f5f3;--text:#111;--muted:#666;--border:#ebebeb}
  ...
  @media(max-width:768px){
    ...
    .r-stats-strip{flex-direction:column!important}
    .r-stats-strip>div{border-right:none!important;border-bottom:1px solid var(--border)!important}
    .r-feature-row{grid-template-columns:1fr!important;gap:32px!important}
    .r-process{flex-wrap:wrap!important;gap:24px!important}
    .r-process>div{width:calc(50% - 12px)!important}
  }
`;
...
const features = [
  { tag:"Feature 01", title:"Your entire job hunt, in one view", body:"A centralized dashboard showing every application — company, role, status, date, and next action. No more spreadsheets.", insight:"Usability tests showed users checked application status most frequently right after submitting. The dashboard was designed to make that moment feel reassuring, not anxious.", src:"/work/gowork/1.png", flip:false },
  { tag:"Feature 02", title:"Know your fit before you apply", body:"Paste a job description and GoWork scores how well your resume matches it — powered by OpenAI. See exactly where you're strong and where you have gaps.", insight:"Early testers used the score as a filter — if under 70%, they'd either improve the resume or skip the role.", src:"/work/gowork/2.png", flip:true },
  { tag:"Feature 03", title:"Up and running in under 2 minutes", body:"Onboarding was designed to get users to their first tracked application as fast as possible. Upload your resume and you're set.", insight:"The version that asked for a resume first had the highest completion rate because it reduced the number of decisions users had to make.", src:"/work/gowork/3.png", flip:false },
  { tag:"Feature 04", title:"Apply anywhere, without the copy-paste", body:"A Chrome extension that auto-fills application forms across job sites — synced to your GoWork profile.", insight:"The biggest complaint in testing wasn't the tracking — it was the repetition of filling the same fields on every site.", src:"/work/gowork/4.png", flip:true },
];
...
export default function GoWorkCaseStudy() {
  return (
    <>
      ...
      {/* HERO */}
      <div className="r-pad" style={{ padding:"120px 6% 80px", background:"var(--black)", position:"relative", overflow:"hidden" }}>
      ...
      {/* OUTCOME BANNER */}
      <div className="r-outcome-banner" style={{ background:"var(--blue)", padding:"20px 6%", display:"flex", alignItems:"center", justifyContent:"center", gap:48, flexWrap:"wrap" }}>
        ...
        <div className="r-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:56, alignItems:"start" }}>
          <div>
            ...
            <SBody>
              ...
              <p style={{ marginTop:16 }}>After talking to 15 job seekers and surveying 40 more, the same frustrations surfaced repeatedly. The process of tracking, applying, and understanding fit was completely broken.</p>
          ...
          <div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
              {[
                ...
                { num:"03", title:"Rejection void", desc:"Applications disappeared with no signal, no feedback — no way to improve" },
      ...
      {/* STATS */}
      <div className="r-stats-strip" style={{ display:"flex", borderTop:"1px solid var(--border)", borderBottom:"1px solid var(--border)" }}>
      ...
      <div className="r-pad" style={{ padding:"96px 6%", maxWidth:1200, margin:"0 auto" }}>
        ...
        <div className="r-grid-2" style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:16, marginTop:40 }}>
          {[
            ...
            { num:"04", h:"Tab overload", p:"A typical session involved LinkedIn, the company site, a resume doc, cover letter, and a spreadsheet.", q:`"My browser looks like I'm losing my mind by the time I finish one application."` },
          ].map(({ num, h, p, q }) => (
      ...
      <div style={{ padding:"80px 0" }}>
        <div style={{ background:"var(--black)", borderRadius:24, padding:60, margin:"0 6%" }}>
          ...
          <div className="r-grid-3" style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:16, marginTop:36 }}>
            {[
      ...
      <div className="r-pad" style={{ padding:"80px 6%", maxWidth:1200, margin:"0 auto" }}>
        ...
        {features.map(({ tag, title, body, insight, src, flip }) => (
          <div key={tag} className="r-feature-row" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:64, alignItems:"center", padding:"64px 0", borderBottom:"1px solid var(--border)" }}>
            {flip && <img src={src} alt={title} style={imgStyle} />}
            <div>
      ...
      <div style={{ background:"var(--black)", padding:"72px 6%" }}>
        <div style={{ maxWidth:1200, margin:"0 auto" }}>
          ...
          <div className="r-grid-3" style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:14, marginTop:36 }}>
            {[
              ...
              { tension:"Tension: Score as number vs score as signal", h:"Show the breakdown, not just the number", p:"An 88% match score alone doesn't tell you what to fix. The breakdown gave users something actionable.", choice:"→ Decision: Always show the breakdown" },
              { tension:"Tension: Auto-track vs manual logging", h:"Zero-effort tracking via extension", p:"Manual logging was the most common reason users abandoned tracking tools. Auto-tracking fixed that.", choice:"→ Decision: Automatic tracking by default" },
      ...
      <div className="r-pad" style={{ padding:"96px 6%", maxWidth:1200, margin:"0 auto" }}>
        ...
        <div className="r-process" style={{ display:"flex", alignItems:"flex-start", marginTop:40 }}>
          {[
