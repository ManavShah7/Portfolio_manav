    ...
    <>
      ...
      <div style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div>
            <h2 style={{fontSize:'clamp(28px,3.5vw,44px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Not all input is equal.</h2>
          ...
          <div>
            <QuoteBlock
              text="Good collaboration shifts conversations from who is right to what works best. When ideas are discussed openly, decisions become stronger and easier to stand behind."
              cite="Why collaboration is not optional"
            />
            <div style={{display:'flex',flexDirection:'column',gap:10}}>
              {[
                ...
                {num:'02',title:'Noise distracts',desc:'Loud but shallow. Driven by personal preference, isolated scenarios, or opinions detached from the product intent.'},
      ...
      <div style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div>
            <h2 style={{fontSize:'clamp(26px,3vw,40px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Three questions I always ask.</h2>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:24}}>Differentiating between feedback and noise requires judgment. I have learned to slow down and run every piece of input through the same filter before acting on it.</p>
            ...
            <div style={{marginTop:20,background:'rgba(124,58,237,.08)',border:'1px solid rgba(124,58,237,.2)',borderRadius:12,padding:'16px 20px',fontSize:14,color:'var(--text)',lineHeight:1.7}}>
              If a comment reveals friction or misunderstanding, it is worth exploring. If it introduces preference without purpose, it is usually noise. Good design decisions come from synthesis, not reaction.
            </div>
          </div>
          <div>
      ...
      <div style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          ...
          <div>
            <h2 style={{fontSize:'clamp(26px,3vw,40px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Protecting the core experience.</h2>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:16}}>Designing well means protecting the primary user, the primary flow, and the primary intent. Saying no thoughtfully is just as important as saying yes - because after all, the only thing that matters is the idea.</p>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:24}}>When every opinion turns into a change, products lose coherence. Each decision might make sense on its own, but together they dilute the experience. The challenge is not being open to input - it is being disciplined about what actually moves the product forward.</p>
            <QuoteBlock
              text="Saying no thoughtfully is just as important as saying yes. The only thing that truly matters is protecting the idea."
              cite="What noise taught me to defend against"
            />
          </div>
        </div>
      </div>
      ...
      <div style={{background:'var(--black)',padding:'80px 8%'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          ...
          <p style={{fontSize:15,color:'#666',lineHeight:1.85,maxWidth:580,marginBottom:48}}>Filtering input is not about dismissing people. It is about being honest about what actually serves the product and the user - and having the discipline to act accordingly.</p>
          <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:16,marginBottom:48}}>
            ...
            <InsightCard num="02" title="Synthesis over reaction" body="Acting on every piece of input is reactive. Good design decisions come from patterns across multiple inputs, not individual opinions." />
          ...
          <div style={{borderTop:'1px solid #1d1d1d',paddingTop:48}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:32,alignItems:'center'}}>
              <div>
                <h3 style={{fontSize:'clamp(22px,2.5vw,34px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.2,color:'#fff',marginBottom:16}}>Good design decisions come from synthesis, not reaction.</h3>
                <p style={{fontSize:15,color:'#666',lineHeight:1.85,marginBottom:16}}>Not everything that comes back from collaboration is feedback. Some of it is noise. Learning to tell the difference - and having the confidence to act on that judgment - is what separates reactive design from intentional design.</p>
                <p style={{fontSize:15,color:'#555',lineHeight:1.85}}>Brick by brick beats forced momentum. Every change that dilutes the experience is a brick you have to remove later.</p>
              </div>
      ...
      <div style={{background:'var(--black)',padding:'80px 8%',borderTop:'1px solid #1a1a1a',textAlign:'center'}}>
        ...
        <div style={{fontSize:'clamp(32px,5vw,60px)',fontWeight:600,color:'#fff',letterSpacing:'-.04em',marginBottom:8,lineHeight:1}}>Dots to Decisions</div>
