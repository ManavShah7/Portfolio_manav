    ...
    <>
      ...
      <div style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div>
            <h2 style={{fontSize:'clamp(28px,3.5vw,44px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Psychology is already at work.</h2>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:16}}>The moment someone opens an interface, they begin reacting emotionally - before logic kicks in. Spacing, motion, copy, and feedback all shape how safe, pressured, confident, or uncertain a user feels. Ignoring psychology does not make a product neutral. It simply makes its impact accidental.</p>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,fontWeight:600,color:'var(--text)'}}>Design, whether we acknowledge it or not, is always guiding behavior.</p>
          </div>
          <div>
            <QuoteBlock
              text="Every product influences human behavior - whether that influence is intentional or not. Ignoring it does not make it go away."
              cite="The realization that changed how I design"
            />
      ...
      <div style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div>
            <h2 style={{fontSize:'clamp(26px,3vw,40px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Your colors define your idea.</h2>
            ...
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:16}}>Choosing color is not about preference. It starts with understanding the values of the company, the idea behind the product, and what the product is trying to communicate. A financial tool should not feel playful. A health product should not feel aggressive.</p>
      ...
      <div style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div style={{display:'flex',flexDirection:'column',gap:12}}>
            {[
              {label:'Streaks',effect:'Shifts motivation from choice to obligation. Missing one day feels like failure.'},
              {label:'Forced milestones',effect:'Arbitrary checkpoints create pressure instead of natural progress.'},
              {label:'Loss-based nudges',effect:'Reminding users what they will lose if they disengage breeds anxiety, not loyalty.'},
          ...
          <div>
            <h2 style={{fontSize:'clamp(26px,3vw,40px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Progress should feel earned, not enforced.</h2>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:16}}>In one of my internships, there was a strong push toward gamification - streaks, rewards, and constant nudges designed to keep users engaged. On paper, these patterns look effective. Metrics rise. Engagement appears to improve.</p>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:24}}>Over time, I started questioning what kind of engagement we were actually creating. Streaks shift motivation from choice to obligation. What begins as encouragement slowly turns into pressure.</p>
            <QuoteBlock
              text="Users should feel supported and not chased. Trust lasts longer than any artificial reward loop ever could."
              cite="What gamification taught me to avoid"
            />
          </div>
        </div>
      </div>
        ...
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          ...
          <div style={{borderTop:'1px solid #1d1d1d',paddingTop:48}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:32,alignItems:'center'}}>
              <div>
                <h3 style={{fontSize:'clamp(22px,2.5vw,34px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.2,color:'#fff',marginBottom:16}}>That respect is what makes experiences feel human.</h3>
      ...
      <div style={{background:'var(--black)',padding:'80px 8%',borderTop:'1px solid #1a1a1a',textAlign:'center'}}>
        ...
        <div style={{fontSize:'clamp(32px,5vw,60px)',fontWeight:600,color:'#fff',letterSpacing:'-.04em',marginBottom:8,lineHeight:1}}>Feedback vs Noise</div>
