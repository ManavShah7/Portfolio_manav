    ...
    <>
      ...
      <div style={{background:'var(--black)'}}>
        <div className="hero-ratio" style={{position:'relative',width:'100%',aspectRatio:'16/7'}}>
          ...
          <div style={{position:'absolute',inset:0,display:'flex',alignItems:'center',justifyContent:'center'}}>
            <h1 style={{fontSize:'clamp(24px,4vw,56px)',fontWeight:600,color:'#fff',letterSpacing:'-.03em',textAlign:'center',padding:'0 24px'}}>&ldquo;Clarity with Controlled Velocity&rdquo;</h1>
          </div>
        </div>
      </div>
      ...
      <div className="r-pad" style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div className="r-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div>
            <h2 style={{fontSize:'clamp(24px,3.5vw,44px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Depth builds the foundation.</h2>
            ...
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,fontWeight:600}}>Velocity without depth does not create momentum, it creates fragility.</p>
          </div>
          <div>
            <QuoteBlock text="Clarity determines whether what is being built can actually stand. Speed without it is just controlled chaos." cite="The core tension I keep coming back to" />
            <div style={{display:'flex',flexDirection:'column',gap:10}}>
              {[
                {num:'01',title:'Moving fast without depth',desc:'Products that skip depth look complete but collapse the moment real users interact with edge cases.'},
      ...
      <div className="r-pad" style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div className="r-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div>
            <h2 style={{fontSize:'clamp(22px,3vw,40px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Thinking better by moving slower.</h2>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:16}}>When I need to truly understand a problem, I step away from the screen and open a notebook. I start by identifying every type of user who might interact with the product — not just ideal users, but first-time users, hesitant users, and those navigating with uncertainty.</p>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:16}}>I map out each small step they might take. Every decision point, every possible hesitation, every moment where friction could appear.</p>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:12}}>
            {[
              {step:'01',label:'Map every user type',desc:'Not just the happy path user. First-timers, hesitant users, confused users.'},
              {step:'02',label:'Trace each micro-step',desc:'Every click, every scroll, every moment where the user has to make a decision.'},
              {step:'03',label:'Ask what the product does next',desc:'At each decision point — does the product support or confuse?'},
      ...
      <div className="r-pad" style={{padding:'96px 8%',maxWidth:1200,margin:'0 auto'}}>
        ...
        <div className="r-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:56,alignItems:'start'}}>
          <div>
            <h2 style={{fontSize:'clamp(22px,3vw,40px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.15,marginBottom:20}}>Strong products anticipate. They do not react.</h2>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:16}}>When you anticipate what a user might do next, you are removing the moments where they can hesitate, get stuck, or lose trust.</p>
            <p style={{fontSize:15,color:'var(--muted)',lineHeight:1.85,marginBottom:24}}>When clarity is built in upfront, velocity becomes controlled. Teams move faster with fewer surprises, less rework, and decisions that do not collapse under real-world use.</p>
            <QuoteBlock text="Speed matters, but only when it is guided by understanding. Clarity gives velocity purpose." cite="What controlled velocity actually means" />
          </div>
          <div>
      ...
      <div style={{background:'var(--black)',padding:'80px 8%'}}>
        <div style={{maxWidth:1200,margin:'0 auto'}}>
          ...
          <div className="r-grid-3" style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:16,marginBottom:48}}>
            ...
            <InsightCard num="02" title="Anticipation over reaction" body="Reactive design patches problems. Anticipatory design removes them." />
            <InsightCard num="03" title="Clarity compounds" body="When every layer of a product is clear, velocity follows naturally. Clarity is what makes speed safe." />
          </div>
          <div style={{borderTop:'1px solid #1d1d1d',paddingTop:48}}>
            ...
            <div className="r-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:32,alignItems:'center'}}>
              <div>
                <h3 style={{fontSize:'clamp(20px,2.5vw,34px)',fontWeight:600,letterSpacing:'-.03em',lineHeight:1.2,color:'#fff',marginBottom:16}}>When the foundation is strong, progress sustains itself.</h3>
                <p style={{fontSize:15,color:'#666',lineHeight:1.85,marginBottom:16}}>Understanding before building is not slower. It is the only approach that actually stays fast.</p>
      ...
      <div style={{background:'var(--black)',padding:'80px 8%',borderTop:'1px solid #1a1a1a',textAlign:'center'}}>
        ...
        <div style={{fontSize:'clamp(28px,5vw,60px)',fontWeight:600,color:'#fff',letterSpacing:'-.04em',marginBottom:8,lineHeight:1}}>Human Psychology<br />and Designing</div>
