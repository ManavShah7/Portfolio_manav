...
export default function Process() {
  ...
  return (
    <section ref={ref} style={{ background: '#000', padding: '100px 5%', overflow: 'hidden' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="process-grid">
          {steps.map((s, i) => (
            ...
            >
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '60%', background: `radial-gradient(ellipse at center bottom, ${s.accent} 0%, transparent 70%)`, pointerEvents: 'none' }} />
              <div style={{ fontSize: 11, fontWeight: 600, color: 'rgba(255,255,255,0.25)', letterSpacing: '0.1em' }}>{s.num}</div>
              <div style={{ position: 'relative', zIndex: 1 }}>
                <h3 style={{ fontSize: 'clamp(20px,2.5vw,32px)', fontWeight: 600, color: '#fff', letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: 14 }}>{s.title}</h3>
